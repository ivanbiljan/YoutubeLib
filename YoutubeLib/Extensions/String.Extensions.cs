...
namespace YoutubeLib.Extensions
{
    ...
    {
        /// <summary>
        ///     Replaces the format items in the specified string with the string representations of the objects in the specified
        ///     array.
        /// </summary>
        ...
        ///     The index of the first character, which must not be negative or greater than the length of
        ///     the string.
        /// </param>
        /// <param name="secondCharIndex">
        ///     The index of the second character, which must not be negative or greater than the length
        ///     of the string..
        /// </param>
