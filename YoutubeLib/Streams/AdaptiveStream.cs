...
namespace YoutubeLib.Streams
{
    ...
    {
        /// <inheritdoc />
        public AdaptiveStream(int itag, string url, StreamType streamType, VideoQuality? videoQuality) : base(itag, url, streamType, videoQuality)
        {
        }
        ...
        public AdaptiveStream(int itag, string url, StreamType streamType, VideoQuality? videoQuality, AdaptiveType adaptiveType, int contentLength, int fps, int bitrate, Resolution resolution) : base(itag, url, streamType, videoQuality)
        {
